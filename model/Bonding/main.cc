...
namespace ModBonding
{
	const double 
		init_mass=1.0,
		init_pres=1.0;
	enum VariablesModBonding
	{
		nvolume=0,
		cvolume,
		mass,
...
using namespace ModBonding;


int	getNvarModBonding()
{
	return maxVarModBonding;
}
void	defVarModBonding
(
	int	ivar,
	char	*name,
	int	&type,
...
void	initModBonding(Domain *dom)
{
	Tool	*&tool=dom->tool;
...
void	stepModBonding(double dt, Domain *dom)
